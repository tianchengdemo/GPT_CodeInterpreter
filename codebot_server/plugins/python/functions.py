...
async def python_exec(code: str, session_id: str = None):
    """
    ...
    session_id: (str, optional):you don't need to care about this parameter, it is automatically generated by the system.
    """
    global myexcutor_dit
    print(f"session_id: {session_id}")
    if session_id is None:
        session_id = str(uuid.uuid4())
    if session_id not in myexcutor_dit:
        myexcutor_dit[session_id] = CodeExecutor()
    myexcutor = myexcutor_dit[session_id]
